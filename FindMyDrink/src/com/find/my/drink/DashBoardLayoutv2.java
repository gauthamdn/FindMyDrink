...
public class DashBoardLayoutv2 extends ViewGroup{
	...
	public DashBoardLayoutv2(Context context) {
		super(context);
	...
	public DashBoardLayoutv2(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public DashBoardLayoutv2(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		final int count = getChildCount();
		//to calculate num of visible child
